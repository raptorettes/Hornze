...
1.  Go to the `Asset Store` tab.
2.  Search for "Maaack's Minimal Game Template Addon".
...
[Basic Setup](/addons/maaacks_game_template/docs/BasicSetup.md) is done through the _Setup Wizard_ at `Project > Tools > Run Maaack's Minimal Game Template Setup...`.
...
[Godot Asset Store - Template](https://store.godotengine.org/asset/maaack/maaacks-minimal-game-template/)  
[Godot Asset Store - Addon](https://store.godotengine.org/asset/maaack/maaacks-minimal-game-template-addon/)  
